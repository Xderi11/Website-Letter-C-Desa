                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                while ($row_detail = mysqli_fetch_assoc($result_detail)) {
                                    echo "<tr>";
                                    echo "<td>" . $row_detail['nama_pemilik'] . "</td>";
                                    echo "<td>" . $row_detail['alamat_pemilik'] . "</td>";
                                    echo "<td>" . $row_detail['no_persil'] . "</td>";
                                    echo "<td>" . $row_detail['keterangan_tanah'] . "</td>";
                                    echo "<td>" . $row_detail['sebab_perubahan'] . "</td>";
                                    echo "<td>" . $row_detail['status_kepemilikan'] . "</td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
...
<?php 
    ...
    // Jika parameter detail tidak ada, redirect atau tampilkan pesan kesalahan sesuai kebutuhan
